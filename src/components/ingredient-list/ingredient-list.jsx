   ...
   return (
      <>
         ...
         <div className={styles.items}>
            {dataArray.map((item) => item.type === props.type && <Item key={item._id} name={item.name} image={item.image} price={item.price} openIngredientModal={props.openIngredientModal} />)}
         </div>
      </>
